...
Every rule ships a clear diagnostic message explaining _why_ the pattern is problematic and _what_ to use instead. Rules are grouped by the AST pattern they target:
